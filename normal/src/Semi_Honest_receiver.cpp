...
int main(int argc, char *argv[])
{
    ...
    std::cout << "Receiver-set registration Time 1 = " << to_string(Registration_time1.count()) << "(ns)" << std::endl;
    std::cout << "Receiver-set registration Time 2 = " << to_string(Registration_time2.count()) << "(ns)" << std::endl;
    std::cout << "Receiver-set registration Time 3 = " << to_string(Registration_time3.count()) << "(ns)" << std::endl;
